...
# This version started from https://gist.github.com/JuanVqz/f8b4941ba627341ae6d298f64e576869
SimpleForm.setup do |config|
  ...
  config.wrappers :select_form, tag: 'div', class: 'field' do |b|
    b.use :html5
    b.use :placeholder
    b.optional :pattern
    b.optional :readonly
    b.use :label, class: 'label'
    b.wrapper :control_wrapper, tag: 'div', class: 'control is-expanded' do |ba|
      ba.use :input, wrap_with: { tag: 'div', class: 'select is-fullwidth' }, error_class: 'is-danger', valid_class: 'is-success'
